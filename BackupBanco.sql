...
CREATE TABLE `pagina_home` (
  ...
  CONSTRAINT `fk_home_unidade` FOREIGN KEY (`idUnidade`) REFERENCES `tbl_unidade` (`idunidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_ambulancia` (
  ...
  CONSTRAINT `fk_amb_unid` FOREIGN KEY (`idUnidade`) REFERENCES `tbl_unidade` (`idunidade`),
