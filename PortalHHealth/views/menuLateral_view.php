  ...
  <div  href="javascript:void(0)" class="closebtn linha_menu" onclick="closeNav()"><a href="">&times;</a></div>
	...
	<div  class="linha_menu" href="#">Unidades
      ...
      <div  class="linha_menu" href="#">Contatos
        ...
        <div class="categorias_ocultas"><a href="contatos/visu_contatos_view.php">Visualizar</a></div>
        <div class="categorias_ocultas"><a href="contatos/visu_contatosRecebidos_view.php">Recebidos</a></div>
     </div>
