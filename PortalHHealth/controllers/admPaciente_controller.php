 ...
 */
 ...
 class controllerCadPaciente{
    ...
    function InserirPaciente($idEndereco){
     ...
     function AtivarPaciente(){
       $idCabecalho = $_GET['id'];

       $ativarCabecalho = new Paciente();

       $ativarCabecalho->id = $idCabecalho;
       return $ativarCabecalho::AtivarPaciente($ativarCabecalho);
     }

     function DesativarPaciente(){
       $idCabecalho = $_GET['id'];

       $ativarCabecalho = new Paciente();

       $ativarCabecalho->id = $idCabecalho;
       return $ativarCabecalho::DesativarPaciente($ativarCabecalho);
     }
